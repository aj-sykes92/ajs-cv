...
* R package development and building R-based software, such as [\textcolor{blue}{agrecalc}](https://www.agrecalc.com).
...
* A [\textcolor{blue}{presentation}](https://github.com/EdinbR/edinbr-talks/raw/master/2019-01-16/Alasdair%20Sykes%20-%20Fringebiscuit%20presentation%20v1%20(no%20tokens).pptx) to the Edinburgh R User Group on using R to collect and analyse data from Twitter *(Edinburgh, 2019)*.
...
To support agricultural policy decision-making by Defra, Alasdairs contribution to this project focused on the development of a number of technical ‘fiches’ providing rapid insight into the abatement potential and costs associated with a number of agricultural GHG mitigation measures. Alasdair developed the requisite models for a number of soil- and land-based mitigation measures, including several novel approaches which had seen no previous inclusion in the UK policy framework. This [\textcolor{blue}{interactive application}](https://alasdair-sykes.shinyapps.io/agroforestry-defra-prelim/) for agroforestry is one of the core outputs from this project.
...
Alasdair contributed to this research project throughout the course of my PhD. In addition to academic stakeholders, the combined research consortium formed a complete industry cross-section, with partners including J Sainsbury PLC and Anglo Beef Processors. Alasdair's contribution to the project comprised GHG model development, and subsequent quantitative analysis of the efficiency measures under consideration by the project team.

# Personal

Alasdair has been based in central Edinburgh since 2014. When not in front of a computer, he is most likely to be found up a mountain, repairing a classic motorcycle, or enjoying the vibrant Edinburgh arts scene.

```{r, echo=FALSE, fig.align='center'}
knitr::include_graphics("logo2.png", dpi = 400)
```
